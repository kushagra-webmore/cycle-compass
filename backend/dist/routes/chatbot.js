...
import { chatMessageSchema } from '../validators/chatbot.js';
import { asyncHandler } from '../utils/async-handler.js';
import { sendChatMessage, getChatHistory, softDeleteChatHistory, createSession, getUserSessions, deleteSession, } from '../services/chatbot.service.js';
 ...
 */
chatbotRouter.post('/sessions', asyncHandler(async (req, res) => {
 ...
 */
chatbotRouter.get('/sessions', asyncHandler(async (req, res) => {
    const userId = req.authUser.id;
 ...
 */
chatbotRouter.delete('/sessions/:id', asyncHandler(async (req, res) => {
    const userId = req.authUser.id;
 ...
 */
chatbotRouter.post('/message', validateBody(chatMessageSchema), asyncHandler(async (req, res) => {
    const userId = req.authUser.id;
 ...
 */
chatbotRouter.get('/history', asyncHandler(async (req, res) => {
    const userId = req.authUser.id;
 ...
 */
chatbotRouter.post('/clear', asyncHandler(async (req, res) => {
    const userId = req.authUser.id;
