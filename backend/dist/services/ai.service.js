...
import { cycleExplainerSystemPrompt, partnerGuidanceSystemPrompt, journalSummarySystemPrompt, dailyInsightsSystemPrompt, buildCycleExplainerUserPrompt, buildPartnerGuidanceUserPrompt, buildJournalSummaryUserPrompt, buildDailyInsightsUserPrompt, } from '../config/prompts.js';
...
export const generateCycleExplainer = async (userId, params) => {
...
export const generatePartnerGuidance = async (userId, params) => {
    const model = createModel();
...
export const generateJournalSummary = async (userId, entries) => {
    const model = createModel();
...
export const generateDailyInsights = async (userId, params) => {
    // Check cache first
