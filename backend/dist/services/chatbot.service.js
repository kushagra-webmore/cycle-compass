 ...
 */
const buildPartnerContext = async (partnerUserId) => {
    const supabase = getSupabaseClient();
 ...
 */
export const getUserSessions = async (userId, isAdmin = false) => {
    const supabase = getSupabaseClient();
    let query = supabase
        .from('chatbot_sessions')
        .select('*')
 ...
 */
export const getChatHistory = async (userId, sessionId, isAdmin = false, limit = 50) => {
    const supabase = getSupabaseClient();
    let query = supabase
        .from('chatbot_messages')
 ...
 */
export const softDeleteChatHistory = async (userId) => {
    const supabase = getSupabaseClient();
