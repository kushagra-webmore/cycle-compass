 ...
 */
export const createSession = async (userId, sessionToken, sessionInfo, expiresInSeconds = 2592000 // 30 days default
) => {
 ...
 */
export const checkConcurrentSessions = async (userId, maxSessions = 5) => {
 ...
 */
export const invalidateAllUserSessions = async (userId, exceptSessionToken) => {
    const supabase = getSupabaseClient();
    let query = supabase
        .from('user_sessions')
        .update({ is_active: false })
