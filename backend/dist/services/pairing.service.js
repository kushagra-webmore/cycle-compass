...
export const createPairingInvite = async (primaryUserId, method) => {
...
const activatePairing = async (pairingId, partnerUserId) => {
    const supabase = getSupabaseClient();
...
export const acceptPairingInvite = async (userId, options) => {
    const supabase = getSupabaseClient();
    let query = supabase
        .from('pairings')
        .select('*')
...
export const getInviteDetails = async (options) => {
    const supabase = getSupabaseClient();
    let query = supabase
        .from('pairings')
...
export const revokePairing = async (userId, pairingId) => {
    const supabase = getSupabaseClient();
    const { data, error } = await supabase
        .from('pairings')
        .select('*')
